...
required packages and time saving objects
...
original csv's pulled from NEON
```{r original csvs}
...
Boxplot of total questing ticks per sampling by life stage and month (Years 2014 - 2019)
...
ticksperarea <- ticks_area_sampled_years_month[,c(1,2, 4,5,6,7,8, 10,11,12,13,14,15)]
#View(ticksperarea)
...
Attached mammal ticks. This data is not as great, but let me know if there's another way you would like me to represent it
