...
collected <- collected[which(collected$site == 'HARV - NORTHEAST' |
                                       collected$site == 'SCBI - MID ATLANTIC' |
                               collected$site == 'ORNL - APPALACHIANS'),]

ggplot(collected, aes(y = sum_counts, x = Month, group = site, color = site))+
  #geom_smooth(se = FALSE)+
  geom_area(aes(fill = site),alpha = .7)+
  clean_background +
  geom_vline(xintercept = 6, alpha = .3, ) +
...
ggsave("geomareanymph.pdf", dpi = 320)
